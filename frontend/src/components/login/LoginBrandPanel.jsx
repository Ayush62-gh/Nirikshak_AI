...
function LoginBrandPanel() {
  return (
    <div className="relative hidden h-screen min-h-0 overflow-hidden bg-[#f0f8f7] lg:flex lg:w-[52%] lg:flex-col lg:justify-between">
      ...
      <div className="relative z-10 px-10 pt-8 xl:px-14">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tight text-[#173b63]">
              NIRIKSHAK<span className="text-[#12988d]"></span>
            </h1>
        ...
        <div className="mt-3 max-w-xl">
          ...
          <p className="mt-3 text-sm font-semibold uppercase tracking-[0.18em] text-[#12988d]">
            Intelligent Inspection Platform
          </p>

          {/* <h2 className="text-4xl font-bold leading-tight tracking-tight text-[#173b63] xl:text-5xl"> */}
          <h2 className="text-4xl font-bold leading-[1.05] tracking-tight text-[#173b63] xl:text-[42px]">
            Inspect smarter.
            <br />
      ...
      {/* Visual */}
        <div className="relative z-10 mt-0 flex min-h-0 flex-1 items-center justify-center overflow-visible px-4 xl:px-8">
          {/* <InspectionVisual /> */}
          <div className="relative z-10 mt-0 flex min-h-0 flex-1 items-center justify-center overflow-visible px-4 xl:px-8">
            <InspectionVisual /></div>
      </div>

      {/* Bottom features */}
      <div className="relative z-10 grid grid-cols-3 gap-4 px-10 pb-6 xl:px-14">
