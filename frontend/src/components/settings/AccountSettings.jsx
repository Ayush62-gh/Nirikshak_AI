...
function AccountSettings() {
  return (
    <section className="mt-5 flex flex-col justify-between gap-4 rounded-2xl border border-red-100 bg-white p-6 shadow-sm sm:flex-row sm:items-center">
      ...
      <button
        type="button"
        className="flex h-10 items-center justify-center gap-2 rounded-lg border border-red-300 bg-white px-5 text-sm font-semibold text-red-500 transition hover:bg-red-50"
      >
        <LogOut size={17} />
        Sign Out
      </button>
